...
//!
//! State lives in `.haw/snapshots/<name>.toml`.
...
pub struct SnapshotRepo {
    pub name: String,
    /// Branch the repo was on (`haw/detached` markers never occur: detached
    /// HEADs are saved by SHA on a `haw/snap-*` branch at restore time).
